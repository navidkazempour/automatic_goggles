...
<<<<<<< HEAD
	        null,
	        !this.state.loading ? _react2.default.createElement(_wikipedia2.default, { title: this.state.data.data.title, body: this.state.data.data.body, facts: this.state.data.data.facts }) : _react2.default.createElement(
	          'h1',
	          null,
	          'Loading...'
	        )
=======
	        { className: 'wiki' },
	        !this.state.loading ? _react2.default.createElement(_wikipedia2.default, { title: this.state.data.data.title, body: this.state.data.data.body }) : _react2.default.createElement('img', { className: 'loading', src: 'images/loading_spinner.gif', alt: 'Loading...' })
>>>>>>> 6b0f6fa0462053ccbb3b8edf3caf37fa80c4d7f6
	      );
	    }
	  }]);
